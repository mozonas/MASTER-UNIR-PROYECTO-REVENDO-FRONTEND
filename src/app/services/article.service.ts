...
export class ArticleService {
  private apiUrl = 'http://revendo-mysql-revendo.e.aivencloud.com:26604/api/userarticles';
...
//   ];
  ...
  // articles = signal<Product[]>(this.mockarticles);

  // getArticleById(id: string): Product | undefined {
  ...
  //   if (index !== -1) {
  //     articles[index] = { ...articles[index], ...updatedProduct };
